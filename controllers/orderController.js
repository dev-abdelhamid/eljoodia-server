...
import ProductionAssignment from '../models/ProductionAssignment.js';
import Return from '../models/Return.js';
import { createNotification } from '../utils/notifications.js';
import { emitSocketEvent, notifyUsers } from '../utils/socketUtils.js';
import { isValidObjectId, validateStatusTransition } from '../utils/validation.js';

// إنشاء طلب مع المهام
export const createOrderWithTasks = async (req, res) => {
...
export const updateTaskStatus = async (req, res) => {
  ...
  try {
    ...
    // تحديث حالة الطلب إذا اكتملت جميع العناصر
    ...
    // تحديث المهمة في ProductionAssignment
...
export const assignChef = async (req, res) => {
  ...
  try {
    ...
    for (const item of items) {
      ...
      // تحقق من توافق القسم إذا لم يكن المستخدم مدير إنتاج
...
// مزامنة المهام
export const syncOrderTasks = async (orderId, io, session) => {
  try {
