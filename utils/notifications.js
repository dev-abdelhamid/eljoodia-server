  ...
  try {
    ...
    const eventData = {
      ...
      user: {
        ...
        role: poppedNotification.user.role,
...
const setupNotifications = (io, socket) => {
  const handleOrderCreated = async (data) => {
    ...
    const eventData = {
      ...
      read: false,
      createdAt: new Date().toISOString(),
      sound: 'https://eljoodia.vercel.app/sounds/new_order.mp3',
      soundType: 'new_order',
      vibrate: [300, 100, 300],
      timestamp: new Date().toISOString(),
    };
  ...
  const handleOrderApproved = async (data) => {
    ...
    const eventData = {
      ...
      read: false,
      createdAt: new Date().toISOString(),
      sound: 'https://eljoodia.vercel.app/sounds/order_approved.mp3',
  ...
  const handleTaskAssigned = async (data) => {
    ...
    const eventData = {
      ...
      read: false,
      createdAt: new Date().toISOString(),
      sound: 'https://eljoodia.vercel.app/sounds/task_assigned.mp3',
  ...
  const handleTaskCompleted = async (data) => {
    ...
    const eventData = {
      ...
      read: false,
      createdAt: new Date().toISOString(),
      sound: 'https://eljoodia.vercel.app/sounds/task_completed.mp3',
  ...
  const handleOrderConfirmed = async (data) => {
    ...
    const eventData = {
      ...
      read: false,
      createdAt: new Date().toISOString(),
      sound: 'https://eljoodia.vercel.app/sounds/order_delivered.mp3',
  ...
  const handleOrderInTransit = async (data) => {
    ...
    const eventData = {
      ...
      read: false,
      createdAt: new Date().toISOString(),
      sound: 'https://eljoodia.vercel.app/sounds/order_in_transit.mp3',
  ...
  const handleReturnStatusUpdated = async (data) => {
    ...
    const eventData = {
      ...
      read: false,
      createdAt: new Date().toISOString(),
      sound: 'https://eljoodia.vercel.app/sounds/return_updated.mp3',
